      ...
      <div className="px-4 pb-24 pt-14">
        <div className="mb-8 text-center">
          <h1 className="mb-2 text-xl font-semibold text-[#d4d4d4]">
            {step === 'result' ? '你的命理人格' : '测一测你的命理人格'}
          </h1>
          <p className="text-sm text-[#858585]">
            {step === 'input' && '30秒出结果 · 和MBTI一样有趣'}
            {step === 'generating' && '正在分析你的命理人格...'}
            {step === 'result' && '基于八字命理分析'}
          </p>
          {step === 'input' && (
            <p className="mt-2 text-xs text-[#6a6a6a]">
              已有 <span className="text-[#d4a853]">12,458</span> 人完成测试
            </p>
          )}
          {step === 'input' && error && (
        ...
        <div className="fixed inset-0 z-50 flex items-end justify-center">
          ...
          <div className="relative w-full max-w-md rounded-t-[6px] border-t border-[#3c3c3c] bg-[#252526] px-5 pb-8 pt-5 shadow-modal">
            <div className="mb-4 text-center">
              <h3 className="text-sm font-semibold text-[#d4d4d4]">分享你的命理人格</h3>
