  ...
  return (
    <div className="px-4">
      ...
      <div className="vscode-card space-y-4 text-sm text-[#1F1D2B]/80">
        ...
        <section className="space-y-2">
          <h2 className="font-semibold text-[#1F1D2B]">2. 用户账户</h2>
        ...
        <section className="space-y-2">
          <h2 className="font-semibold text-[#1F1D2B]">5. 免责声明</h2>
        ...
        <section className="space-y-2">
          <h2 className="font-semibold text-[#1F1D2B]">6. 知识产权</h2>
          <p>6.1 本服务相关的软件、算法、设计、内容的全部知识产权归运营方所有。</p>
          <p>6.2 未经书面许可，禁止复制、修改、传播本服务的任何内容。</p>
        </section>

        <section className="space-y-2">
          <h2 className="font-semibold text-[#1F1D2B]">7. 协议变更</h2>
          <p>我们有权根据需要修改本协议。修改后的协议将在页面公示后生效。如您继续使用本服务，视为接受修改后的协议。</p>
        </section>

        <section className="space-y-2">
          <h2 className="font-semibold text-[#1F1D2B]">8. 联系我们</h2>
