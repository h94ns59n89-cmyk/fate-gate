...
function renderComparisonHTML(data: Record<string, unknown>): string {
  ...
  function tag(text: string): string {
    return `<span style="display:inline-flex;align-items:center;justify-content:center;border-radius:999px;background:rgba(155,127,187,0.08);padding:2px 10px;font-size:11px;color:#9B7FBB;">${esc(text)}</span>`;
  }
  ...
  if (data.summary_tag) html += `<span style="display:inline-flex;align-items:center;justify-content:center;border:1px solid rgba(155,127,187,0.25);background:rgba(155,127,187,0.08);border-radius:3px;padding:4px 14px;font-size:12px;color:#9B7FBB;font-weight:500;">${esc(data.summary_tag as string)}</span>`;
