    ...
    <div className="px-4">
      ...
      <div className="vscode-card space-y-4 text-sm text-[#d4d4d4]/80">
        <section className="space-y-2">
          <h2 className="font-semibold text-[#d4d4d4]">1. 信息收集</h2>
        ...
        <section className="space-y-2">
          <h2 className="font-semibold text-[#d4d4d4]">2. 信息使用</h2>
          <p>您的信息仅用于以下目的：</p>
        ...
        <section className="space-y-2">
          <h2 className="font-semibold text-[#d4d4d4]">3. 信息存储与保护</h2>
        ...
        <section className="space-y-2">
          <h2 className="font-semibold text-[#d4d4d4]">4. 信息共享</h2>
        ...
        <section className="space-y-2">
          <h2 className="font-semibold text-[#d4d4d4]">5. 您的权利</h2>
        ...
        <section className="space-y-2">
          <h2 className="font-semibold text-[#d4d4d4]">6. 政策更新</h2>
          <p>我们可能会不定期更新本隐私政策。重大变更将通过在应用内通知的方式告知您。</p>
        </section>

        <section className="space-y-2">
          <h2 className="font-semibold text-[#d4d4d4]">7. 联系方式</h2>
