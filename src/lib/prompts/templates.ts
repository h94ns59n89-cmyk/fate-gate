...
- 月令本气被日主克 → -1 分（如壬水生于辰戌丑未月，土→水，土克水）
...
## 步骤 4: 用神忌神选取（四种方法，按优先级看）
从高到低排查，先满足优先级高的：

**第一优先：调候（季节气候对命局的影响，在任何情况下都要先看）**
- 生于巳/午/未月（夏）：优先找水（子/亥/壬/癸）做调候用神
- 生于亥/子/丑月（冬）：优先找火（巳/午/丙/丁/戊/未戌燥土）做调候用神
- 生于寅/卯/辰月（春）：余寒，仍需要火暖局
- 生于申/酉/戌月（秋）：金燥，需要水润局
- 调候用神即使和扶抑用神冲突，也以上面季节规则为准（案例：腊月丙火哪怕身强也先用木火暖局而非金水）
